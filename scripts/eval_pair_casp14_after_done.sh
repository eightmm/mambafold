...
RUN_DIR="outputs/train/direct_pair_global20k_v1"
CKPT="${RUN_DIR}/ckpt_0020000.pt"
OUT_DIR="outputs/eval/casp14_70_direct_pair_global20k_sde500_20260630"
...
echo "[wait] checkpoint exists; waiting for pair train process to exit"
while pgrep -f "scripts/train.py --config configs/direct_allatom_pair_global20k.yaml" >/dev/null; do
  sleep 60
done
...
out = Path("outputs/eval/casp14_70_direct_pair_global20k_sde500_20260630")
